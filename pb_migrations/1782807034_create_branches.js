...
migrate((app) => {
  ...
  try {
    const collection = new Collection({
      ...
      "updateRule": "@request.auth.id != '' && @request.auth.merchant_id = merchant.id",
      "deleteRule": "@request.auth.id != '' && @request.auth.merchant_id = merchant.id",
      "options": {},
      "fields": [
        { "id": "text_id_br", "name": "id", "type": "text", "system": true, "required": true, "primaryKey": true },
